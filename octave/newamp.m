...
function [rate_K_surface rate_K_sample_freqs_kHz] = resample_const_rate_f(model, rate_K_sample_freqs_kHz)
  ...
  for f=1:frames
    ...
    %Normalize mel freqs under base pitch to base pitch amplitude for better interpolation back to Am
    kk = 1;
    while rate_L_sample_freqs_kHz(1)>rate_K_sample_freqs_kHz(kk)
