...
% Generate a C header file with an FM modulated sine wave
function fm_tx_chfile(tx_file_name)
  fm_states.Fs = 48000;  
  fm_states.fm_max = 3E3;
  fm_states.fd = 5E3;
  fm_states.fc = 0;
 ...
 % nsam = length(tx);
  ...
  fprintf(fout,"#include \"comp.h\"\n\n#define FM_TEST_LEN %d\n\n",length(tx));
  fprintf(fout,"static COMP FM_test_d[] = {\n");
  for s = tx
    fprintf(fout,"{%f,%f},\n",real(s),imag(s));
  end
  fprintf(fout,"};");
